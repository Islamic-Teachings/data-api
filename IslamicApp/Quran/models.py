...
class SurahModel(models.Model):
    quran = models.ForeignKey(QuranModel, on_delete=models.CASCADE)
...
class AyahModel(models.Model):
    surah = models.ForeignKey(SurahModel, on_delete=models.CASCADE)
...
class AyahRecitation(models.Model):
    ayah = models.ForeignKey(AyahModel, on_delete=models.CASCADE)
